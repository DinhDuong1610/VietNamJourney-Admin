...
class PostController extends Controller
{
    ...
    public function getComment(Request $request)
    {
        ...
        try {
            ...
            $comment = DB::table('comment as c')
                ->select('c.User_ID', 'c.Content', 'c.ImageComment', 'c.created_at', 'u.Name', 'u.Image')
            ...
            if ($comment) {
                // Định dạng thời gian
                $comment->created_at = $this->timeElapsedString($comment->created_at);
            ...
            foreach ($comments as $comment) {
                ...
                if ($user) {
                    $formattedComments[] = [
                        ...
                        'time' => $this->timeElapsedString($comment->created_at),
                    ];
                }
            }
    ...
    public function addComment(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'ImageComment' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:51200',
        ]);
