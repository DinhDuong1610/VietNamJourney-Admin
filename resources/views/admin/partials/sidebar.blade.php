...
<aside class="main-sidebar sidebar-dark-success elevation-4 position-fixed vh-100 saiba" style="background-color: #28A745">
           ...
           with font-awesome or any other icon font library -->
                <li class="nav-item">
                    <a href="{{ route('admin.dashboard') }}" class="nav-link">
                        <i class="nav-icon fas fa-tachometer-alt i"></i>
                        <p>QUẢN LÝ</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        <i class="nav-icon fas fa-flag i"></i>
                        <p>
                            Chiến dịch
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        <i class="nav-icon fas fa-money-bill-alt i"></i>
                        <p>
                            Quỹ
                            <i class="right fas fa-angle-left"></i>
                        </p>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.pages.email.index') }}" class="nav-link">
                        <i class="nav-icon fas fa-envelope i"></i>
                        <p>Email</p>
                    </a>
                </li>
            </ul>
